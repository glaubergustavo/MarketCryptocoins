...
class MarketChartDataWoker {
    ...
    func doFetchMarketChart(id: String, baseCoin: String, from: String, to: String, completion: @escaping ((Result<MarketChartModel?, CryptocurrenciesError>) -> Void)) {
        dataProvider?.fetchMarketChartRange(by: id, currency: baseCoin, from: from, to: to)
        self.completion = completion
    }
}

extension MarketChartDataWoker: MarketChartDataProviderDelegate {
